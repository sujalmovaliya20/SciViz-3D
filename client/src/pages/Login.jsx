      ...
      <div style={{
        ...
        <div className="branding-section" style={{
          ...
          <h1 style={{ fontFamily:'Syne,sans-serif', fontWeight:800,
            ...
            marginBottom:'16px' }}>
            Explore Science<br/>
            <span style={{color:'#00e5ff'}}>in 3D</span>
          </h1>

          <p style={{ fontFamily:'Space Mono,monospace', fontSize:'13px',
            color:'#4a5a7a', lineHeight:1.8, marginBottom:'32px' }}>
            60+ interactive experiments for<br/>
            Class 10 & 12 NCERT/CBSE curriculum
          </p>

          {/* Feature pills */}
          {[
            { icon:'🧲', text:'Physics — 28 experiments' },
            { icon:'⚗️', text:'Chemistry — 17 experiments' },
            { icon:'🌿', text:'Biology — 15 experiments' },
          ].map(f => (
        ...
        <div className="form-container" style={{
          ...
          <div style={{ marginBottom:'32px' }}>
            <h2 style={{ fontFamily:'Syne,sans-serif', fontWeight:800,
              fontSize:'26px', color:'#e0eaff', marginBottom:'8px' }}>
              Welcome back 👋
            </h2>
